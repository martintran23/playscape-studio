    ...
    <aside className="flex h-full min-h-0 w-72 shrink-0 flex-col border-r border-slate-200 bg-white">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">
          {isPark
            ? "Draw and close a region on the map, then enter design mode to add playground equipment."
            : "Place equipment inside the highlighted region only."}
        </p>
        {selectedLocation ? (
        ...
        <>
          <section className="mb-6 rounded-lg border border-amber-200 bg-amber-50/80 p-3">
            ...
            <p className="text-xs text-amber-900/70">
              Turn on, click terrain to add corners, then finish the outline. Equipment is placed after you open design
              mode.
            </p>
          ...
          <section className="mt-8 rounded-lg border border-slate-200 bg-slate-50 p-3">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <button
                type="button"
                onClick={loadScene}
                className="flex-1 rounded-md bg-indigo-600 px-3 py-2 text-sm text-white"
              >
                Load
              </button>
            </div>
            <p className="mt-3 text-xs text-slate-500">
              Snap: 0.5m translate, 22.5deg rotate. Items cannot overlap and must stay in bounds.
            </p>
          </section>
